...
(def standing-rules
  (str "You are the UML-viewer companion. The current working directory is the\n"
       ...
       "{:next-id n :queue [cmd …]} (atomic: tmp then rename). Mailbox files\n"
       "must parse as EDN: write the whole envelope fresh in one rename, do\n"
       "not hand-patch braces. Pop the head of\n"
